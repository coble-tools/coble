...
# Target environment r-362
# Target path /home/ralcraft/miniforge3/envs/r-362
#####################################################
...
/home/ralcraft/miniforge3/bin/conda env remove --name r-362 -y 2>/dev/null || true
/home/ralcraft/miniforge3/bin/conda create --no-default-packages --name r-362 -y
export PYTHONNOUSERSITE=1
unset PYTHONPATH
umask 0022
# activate environment
conda activate r-362
...
cp recipes/utils/r-362/validate/validate.sh ${CONDA_PREFIX}/bin/validate.sh
