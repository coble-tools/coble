...
/home/ralcraft/miniforge3/bin/conda env remove --name carbine -y 2>/dev/null || true
/home/ralcraft/miniforge3/bin/conda create --no-default-packages --name carbine -y
