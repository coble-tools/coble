...
conda:
  - jpeg=9f@defaults
  - kernel-headers_linux-64=3.10.0@defaults

conda:
  - krb5=1.13.2@https://repo.anaconda.com/pkgs/free
...
conda:
  ...
  - sysroot_linux-64=2.17@defaults
  - tk=8.6.15@defaults
