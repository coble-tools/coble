...
#####################################################
# This template demonstrates the possible features along with the defaults
#####################################################
coble:
...
flags:
  ...
  - network-viz: false # true / false - installs R packages for network visualisation of R package dependencies
