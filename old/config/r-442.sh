...
conda install -y bioconda::bioconductor-rtracklayer
Rscript -e "BiocManager::install(c('biomaRt', 'GenomicFeatures', 'BSgenome'))"
Rscript -e "BiocManager::install(c('VariantAnnotation', 'ensembldb', 'biovizBase', 'Gviz', 'GenomicInteractions'))"
...
#Rscript -e "devtools::install_url('https://github.com/GreenleafLab/ArchR/archive/refs/heads/master.zip', repos = BiocManager::repositories())" #RA
...
#Rscript -e "BiocManager::install('ShortRead')" #RA
coble@bioc@ShortRead

#conda install -y -c conda-forge r-eulerr #RA
coble@r@eulerr
...
# Rscript -e "BiocManager::install('Chicago')" #RA
coble@bioc@Chicago
...
# conda install -y conda-forge::r-magick #RA
coble@r@magick
# Rscript -e "BiocManager::install('GSVA')" #RA
coble@bioc@GSVA
...
# conda install -y conda-forge::r-gdtools #RA
coble@r@gdtools
# Rscript -e "BiocManager::install('pcaMethods')" #RA
...
coble@bioc@fansi gert gower DeconRNASeq
...
coble@bioc@NanoStringNCTools GeomxTools GeoMxWorkflows
