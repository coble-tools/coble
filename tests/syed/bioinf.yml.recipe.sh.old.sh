...
'r-sf' 
# bioc-package:
Rscript -e 'BiocManager::install("chromVAR", dependencies=TRUE, Ncpus=8)'
Rscript -e 'BiocManager::install("ComplexHeatmap", dependencies=TRUE, Ncpus=8)'
Rscript -e 'BiocManager::install("motifmatchr", dependencies=TRUE, Ncpus=8)'
Rscript -e 'BiocManager::install("slingshot", dependencies=TRUE, Ncpus=8)'
Rscript -e 'BiocManager::install("grr", dependencies=TRUE, Ncpus=8)'
# r-conda:
#  - TFMPvalue
#r-url:
...
# r-package:
Rscript -e 'install.packages("ShortRead", repos="https://cloud.r-project.org", dependencies=TRUE, Ncpus=8)'
...
# Added to try to fix
# r-package:
Rscript -e 'install.packages("maptools", repos="https://cloud.r-project.org", dependencies=TRUE, Ncpus=8)'



Updated receipe on: 2025-12-29 at 11:10:43 GMT by ralcraft
